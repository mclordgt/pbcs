...
class Planning extends CI_Controller {
	...
	public function __construct() {
		...
		$this->data['headerData']['css'][] 		= 'css/planning.css';
		...
		$this->data['headerData']['scripts'][] 	= 'js/planning/ajax.js';
		...
		$this->data['footerData']['scripts'][] 	= 'js/planning/planning.js';
	...
	public function client()
	{
		...
		$this->data['headerData']['pageTitle'] = 'PBCS - Planning';

		$this->data['pageData']['plan'] = $this->m_plans->getPlan( $this->plan_id );
		$this->data['pageView'] = 'planning';
		...
		$this->load->view('master-planning', $this->data);
	}
